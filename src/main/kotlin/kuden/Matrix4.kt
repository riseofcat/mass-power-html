...
class Matrix4 {
  ...
  fun get() = matrix
  fun toFloat32Arr() = Float32Array(get().toTypedArray())
  fun mul(other:Matrix4) = mul(other.get())
  ...
  protected fun mul(other:FloatArray) {
    if(other.size!=16) throw IllegalArgumentException("Matrix size should be 16!")
